...
export default function LoginPage() {
  ...
  const onSubmit = async (values: LoginForm) => {
    ...
    try {
      const { data } = await authApi.login({
        ...values,
        phone_number: formatToNigeriaInternational(values.phone_number),
      });
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "var(--surface)" }}>
      {/* Left panel */}
      <div
        className="hidden lg:flex flex-col justify-between w-110 p-12"
      ...
      >
        <div>
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            A transparent, Shariah-compliant cooperative management system for
            Muslim teachers across Nigeria.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {[
            ...
            {
              label: "Waterfall Allocation",
              desc: "Auto-distributes deductions",
            },
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              <input
                ...
                style={{
                  borderColor: errors.phone_number ? "#991b1b" : "#e2e8f0",
                }}
              />
              {errors.phone_number && (
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  style={{
                    borderColor: errors.password ? "#991b1b" : "#e2e8f0",
                  }}
                />
                <button
                  type="button"
